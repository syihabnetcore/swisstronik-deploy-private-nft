...
```bash
git clone https://github.com/syihabnetcore/swisstronik-deploy-private-nft.git
```
```bash
...
contract PrivateNFT is ERC721, Ownable {
    ...
    constructor(address initialOwner) ERC721("LangkyPrivate", "LNKYPRVT") Ownable(initialOwner) {}
...
by :
github : [syihabnetcore](https://github.com/syihabnetcore)
twitter : @syihabnetcore
telegram : @syihabnetcore
